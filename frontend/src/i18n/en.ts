export const en: Record<string, string> = {
  ...
  'auth.login.rateLimited': 'Too many login attempts. Please try again in a few minutes.',
  'auth.login.networkError': 'Unable to connect. Please check your internet connection.',
  ...
  'auth.forgotPassword.success': 'If an account with that email exists, a reset link has been sent. Check your inbox.',
  ...
  'auth.resetPassword.invalidToken': 'This reset link is invalid or has expired.',
